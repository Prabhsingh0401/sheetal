  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center text-[#694708] mt-10">
        <h1 className="text-4xl md:text-6xl font-light mb-4 font-[family-name:var(--font-optima)] uppercase tracking-wider">
          {title}
        </h1>
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="text-center mb-8 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-light mb-6 text-[#1a1a1a] font-[family-name:var(--font-outfit)] uppercase tracking-[0.2em]">
            {bannertext}
          </h2>
