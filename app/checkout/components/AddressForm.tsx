...
const AddressForm: React.FC<AddressFormProps> = ({ onSuccess, onCancel, initialData, addressId }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simple validation
        if (!formData.firstName || !formData.phoneNumber || !formData.addressLine1 || !formData.postalCode) {
    ...
    return (
        <form onSubmit={handleSubmit} className="border border-gray-200 p-4 md:p-6 bg-white shadow-sm mt-4">
            <h3 className="text-xl text-[#785e32] mb-4 font-montserrat">{addressId ? "Edit Address" : "Add New Address"}</h3>
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    required
                />
                <p className="text-xs text-gray-500 mt-1">This phone number will be used to send you offers & updates</p>
            </div>
            ...
            <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2">Save this address as (optional)</label>
                <div className="flex gap-3">
                    {["Home", "Office", "Other"].map((type) => (
                        <button
                            ...
                            className={`px-4 py-1.5 rounded-full text-sm border transition-colors ${formData.addressType === type
            ...
            <div className="flex gap-4">
                ...
                >
                    {loading ? "Saving..." : (addressId ? "UPDATE & CONTINUE" : "SAVE & CONTINUE")}
                </button>
                <button
                    type="button"
                    onClick={onCancel}
