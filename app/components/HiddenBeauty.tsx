      ...
      <div className="container mx-auto py-12 px-4 text-center font-[family-name:var(--font-optima)]">
        ...
        <div className="flex flex-col justify-center items-center h-[400px] text-center">
          <div className="w-20 h-20 bg-[#f9f9f9] rounded-full flex items-center justify-center mb-6 shadow-inner">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#5d4112" className="w-10 h-10">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
             </svg>
          </div>
          <h3 className="text-xl font-medium text-[#5d4112] mb-2">Something went wrong</h3>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="relative rounded-[22px] overflow-hidden group">
                  <Link href={`/product-list?category=${cat.slug}`} className="block">
                    <Image
                      src={getCategoryImageUrl(cat, '/assets/placeholder-category.jpg')}
                      alt={cat.name}
                      width={400}
                      height={600}
