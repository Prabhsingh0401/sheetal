  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center text-[#694708] mt-10">
          <h1 className="text-4xl md:text-6xl font-light mb-4 font-[family-name:var(--font-optima)] uppercase tracking-wider">Saree</h1>
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="text-center mb-8 max-w-3xl mx-auto">
          ...
          <p className="text-gray-500 font-light leading-relaxed text-lg">
            Get styled with the high-fashion products and transform yourself. Trending Products
          </p>
        </div>
      </div>
    </>
