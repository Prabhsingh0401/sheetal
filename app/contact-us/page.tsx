      ...
      <div className="container-fluid p-0 relative overflow-hidden md:mt-[75px] mb-5 text-center">
        <div className="relative">
          ...
          <div className="w-full border-b border-[#ffcf8c] bg-white/80 md:bg-transparent py-5">
            <h1 className="font-optima text-[35px] text-[#6a3f07] font-normal">Contact Us</h1>
                     ...
                     <div className="content">
                        <div className="relative">
                           <div className="w-full px-2 mb-8">
                              ...
                              <h5 className="font-[family-name:var(--font-montserrat)] text-[20px] font-normal">Please contact us with any questions or concerns.</h5>
                           </div>
                           ...
                           <div className="flex flex-wrap -mx-4">
                                 ...
                                 <div className="border border-dashed border-black p-[33px_20px] mb-0 h-auto md:h-[160px] w-full text-center flex items-center justify-center">
                                    <div className="info">
                                       <div className="email">
                                          ...
                                          <h4 className="inline-block font-medium">Email:</h4>
                                          <p className="font-[family-name:var(--font-montserrat)] text-black mt-2">info@studiobysheetal.com</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div className="border border-dashed border-black p-[33px_20px] mb-0 h-auto md:h-[160px] w-full text-center flex items-center justify-center">
                                    <div className="info">
                                       <div className="email">
                                          ...
                                          <h4 className="inline-block font-medium">Mobile:</h4>
                                          <p className="font-[family-name:var(--font-montserrat)] text-black mt-2">+91 99588 13913</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div className="w-full text-center mt-12 px-4">
                                 ...
                                 <p className="font-[family-name:var(--font-montserrat)] text-black mb-4">
                                    Thank you for visiting us. We’d love to hear from you. Please fill in the details below. Our team member will contact you shortly.
                                 </p>
                                 <p>&nbsp;</p>
